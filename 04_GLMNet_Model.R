...
data = read.csv("./IMDb_Sentiment_Analysis/Data/corpus_preprocessed.csv",sep=",",stringsAsFactors = FALSE)
...
write.csv(test,"./IMDb_Sentiment_Analysis/Data/test.csv", row.names = F)
...
save(tr_model, file= "./IMDb_Sentiment_Analysis/Data/tr_model.Rdata")
...
save(glmnet_clas, file= "./IMDb_Sentiment_Analysis/Data/glmnet_clas.Rdata")
